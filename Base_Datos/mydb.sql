...
CREATE TABLE `CONTACTO` (
  ...
  KEY `fk_CONTACTO_ESCUELA1_idx` (`ESCUELA_ID_ESCUELA`),
  ...
  CONSTRAINT `fk_CONTACTO_ESCUELA1` FOREIGN KEY (`ESCUELA_ID_ESCUELA`) REFERENCES `ESCUELA` (`ID_ESCUELA`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ESCUELA` (
  ...
  KEY `fk_ESCUELA_CALLE1_idx` (`CALLE_ID_CALLE`),
  KEY `fk_ESCUELA_CIUDAD1_idx` (`CIUDAD_ID_CIUDAD`),
  KEY `fk_ESCUELA_REGION1_idx` (`REGION_ID_REGION`),
  CONSTRAINT `fk_ESCUELA_CALLE1` FOREIGN KEY (`CALLE_ID_CALLE`) REFERENCES `CALLE` (`ID_CALLE`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_ESCUELA_CIUDAD1` FOREIGN KEY (`CIUDAD_ID_CIUDAD`) REFERENCES `CIUDAD` (`ID_CIUDAD`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_ESCUELA_REGION1` FOREIGN KEY (`REGION_ID_REGION`) REFERENCES `REGION` (`ID_REGION`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `REGION` VALUES (1,'araucania',9,'cautin');
...
CREATE TABLE `USUARIO` (
  ...
  `CIUDAD_ID_CIUDAD` int(11) NOT NULL,
  `CALLE_ID_CALLE` int(11) NOT NULL,
  `ocupacionUsuario` varchar(15) COLLATE latin1_spanish_ci DEFAULT NULL,
  `ESCUELA_ID_ESCUELA` int(11) NOT NULL,
  ...
  KEY `fk_USUARIO_ESCUELA1_idx` (`ESCUELA_ID_ESCUELA`),
  ...
  CONSTRAINT `fk_USUARIO_ESCUELA1` FOREIGN KEY (`ESCUELA_ID_ESCUELA`) REFERENCES `ESCUELA` (`ID_ESCUELA`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-05-31 12:08:10
